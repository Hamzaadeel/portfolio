...
import { FaPhoneAlt, FaDownload, FaEye } from 'react-icons/fa';
      ...
      <div className="relative z-6 w-full px-4 md:px-0 flex flex-col-reverse md:flex-row items-center justify-between max-w-6xl mx-auto">
        ...
        <div className="w-full md:w-1/2 px-8 text-center md:text-left">
          ...
          <p className="text-lg md:text-xl text-black font-serif leading-tight mb-4 text-shadow-md animate-slide-in-left">
            A passionate computer science graduate <br />
            willing to go the extra mile to achieve greatness and<br />
            provide high performance websites with eye-catching designs and features.
          </p>
          <div className="flex justify-center md:justify-start space-x-4 px-4 py-4">
            ...
            <Link
              ...
              smooth="true"
              duration={700}
              className="cursor-pointer bg-black text-white px-8 py-4 rounded-full text-lg font-semibold shadow-xl hover:bg-white hover:text-black transition duration-300 ease-in-out transform hover:scale-105 animate-slide-in-right delay-400 flex items-center space-x-2"
            >
              <FaPhoneAlt className="h-6 w-4" /> {/* Phone Icon */}
            ...
            <a
              ...
              className="bg-black text-white px-8 py-4 rounded-full text-lg font-semibold shadow-xl hover:bg-white hover:text-black transition duration-300 ease-in-out transform hover:scale-105 animate-slide-in-right delay-400 flex items-center space-x-2"
            >
